...
// Standard genetic code (single-letter amino acids; '*' = stop). Codons are
// translated as written on the coding strand. Unknown codons translate to 'X'.
...
/** Translates a single 3-letter codon to its amino acid (X if unknown). */
