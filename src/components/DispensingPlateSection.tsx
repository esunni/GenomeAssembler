      ...
      <div className="plate-box" style={{ position: 'relative', marginTop: '1.5rem' }}>
        ...
        <div className="helper-box" style={{ padding: '0.75rem', border: 'none', marginTop: '1rem', backgroundColor: '#f8f9fa', fontSize: '0.85rem' }}>
          ...
          <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1, backgroundColor: '#eef2f5', padding: '0.75rem', borderRadius: '6px', display: 'flex', gap: '0.75rem', alignItems: 'flex-end', minWidth: '320px' }}>
              <label style={{ fontSize: '0.85rem', flex: 1, minWidth: '140px' }}>
                Well name prefix
                <input
